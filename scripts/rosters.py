...
ROSTERS = {
    "Banking": {
        "Banking Majors": [
            ...
            "CARRINGTON MORTGAGE SERVICE", "EAST WEST BANCORP INC", "Midland Credit Management",
            ...
            "Versana LLC", "APPLIED SYSTEMS INC", "Bloomberg LP", "Datasite", "Insurity",
            "Q2 Software", "ALLY FINANCIAL", "BAYVIEW FINANCIAL", "Eastdil Secured, L.L.C.",
            "FNB CORPORATION", "South State Bank", "State Employees Credit Union",
            "SYNOVUS FINANCIAL CORP", "Alight", "DOVENMUEHLE MORTGAGE INC", "OneMain Financial",
            "Rock Holding Inc.", "Select Portfolio Servicing, Inc.", "AUTOBOOKS", "Flagstar Bank",
            "FREDDIE MAC", "Synchrony Financial", "WEBSTER BANK", "Edfinancial Services",
